...
const signup = async (req, res) => {
    ...
    try {
        signup_validate(email, password, first_name, last_name, gender, dob);
...
const signup_staff = async (req, res) => {
    ...
    try {
        ...
        const user = await User_Model.create({ email, password: hash, first_name, last_name, gender, dob, role });
...
const signup_validate = async (email, password, first_name, last_name, gender, dob) => {
    // Check if email is provided
    if (!email)
